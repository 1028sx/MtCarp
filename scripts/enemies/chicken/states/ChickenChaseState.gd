...
@export_group("跳躍決策參數")
# 情境1: 隨機前跳
@export var random_jump_min_chase_time: float = 1.0  # 至少追擊多久後才可能觸發跳躍
@export var random_jump_chance: float = 0.2         #每秒觸發目標跳躍的機率
@export var random_jump_velocity: Vector2 = Vector2(180, -200) # 隨機前跳的固定速度

# 情境2: 目標跳躍攻擊
@export var target_jump_max_dist: float = 200.0
@export var target_jump_min_dist: float = 100.0
@export var target_jump_chance: float = 0.4         #每秒觸發目標跳躍的機率
...
@export_group("通用參數")
@export var attack_distance: float = 60.0 # 進入攻擊狀態的距離
#endregion
...
var _jump_calculation_cooldown_timer: float = 0.0 # 跳躍計算冷卻
const JUMP_CALCULATION_COOLDOWN = 1.0 # 計算失敗後的冷卻時間
#endregion
